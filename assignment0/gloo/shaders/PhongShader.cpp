...
void PhongShader::SetLightSource(const LightComponent& component) const {
  ...
  SetUniform("direction_light.enabled", false);
  if (light_ptr->GetType() == LightType::Ambient) {
    ...
    auto direction_light_ptr = static_cast<DirectionalLight*>(light_ptr);
    SetUniform("direction_light.enabled", true);
    SetUniform("direction_light.direction", direction_light_ptr->GetDirection());
    SetUniform("direction_light.diffuse", direction_light_ptr->GetDiffuseColor());
    SetUniform("direction_light.specular", direction_light_ptr->GetSpecularColor());
  }
  else{
